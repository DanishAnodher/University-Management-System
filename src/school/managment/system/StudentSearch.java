...
public class StudentSearch implements ActionListener{
...
//Radio Buttons
    ...
    StudentSearch(String studentName, String grNo){
        //ImageIcon
...
//********End of labels and texts***********
        ...
        Student s = new Student(studentName, Integer.parseInt(grNo));
