...
public class StudentSearch2 implements ActionListener{
...
//Radio Buttons
    ...
    StudentSearch2(String studentName, String gr, String tn){
...
//********End of labels and texts***********
        ...
        Student s = new Student(studentName, Integer.parseInt(gr));

        text1.setText(s.name);
        text2.setText(s.fName);
        text3.setText(s.caste);
        text4.setText(String.valueOf(s.cnic));
        text5.setText(s.dob);
        text6.setText(s.doa);
        ...
        text8.setText(s.address);
        text9.setText(s.religion);
        text10.setText(s.classs);
        text11.setText(s.section);
        text12.setText(String.valueOf(s.gr));
