...
//*******Start Global variables*******
    JTextArea textArea;
    String text ="TEACHER  REGISTRATION";
    int i;
    int number=200;
//******Global Vriables********
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(e.getSource() == add){
            if(text1.getText().equalsIgnoreCase("") || text2.getText().equalsIgnoreCase("") || text3.getText().equalsIgnoreCase("") || text4.getText().equalsIgnoreCase("") || text5.getText().equalsIgnoreCase("") || text6.getText().equalsIgnoreCase("") || text8.getText().equalsIgnoreCase("") || text9.getText().equalsIgnoreCase("") || text10.getText().equalsIgnoreCase("") || text11.getSelectedIndex()==-1 || text12.getText().equalsIgnoreCase("") || group.isSelected(null)){
                ...
                Teacher.addTeacher(text1.getText(), text2.getText(), text3.getText(), text4.getText(), text5.getText(), text6.getText(), gender, text8.getText(), text9.getText(), text10.getText(), text11.getSelectedIndex(), text12.getText());
                JOptionPane.showMessageDialog(null, "one Teacher is successfully hired", "Information", JOptionPane.INFORMATION_MESSAGE);
